...
function Banner() {
  return (
    <div className="h-fit px-10 flex items-center py-5">
      <div className="flex-1 flex flex-col space-y-8 items-center lg:items-start text-center lg:text-left">
        <h1 className="text-5xl font-serif font-black">
          We'll help you get <br className="hidden md:block" />
          skillful sooner.
        </h1>
        <p className="text-xl">
          If you've decided to learn new skill, we're here to help you <br />{" "}
          with that.
        </p>
        <div>
          <Button>
      ...
      <div className="flex-1 items-center justify-center h-full w-full hidden lg:flex">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          data-name="Layer 1"
          width="500"
